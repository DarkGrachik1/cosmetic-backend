# Generated by Django 4.2.5 on 2024-01-09 12:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('clinical_trial', models.IntegerField(blank=True, choices=[(0, 'Одобрено'), (1, 'Отказано')], null=True, verbose_name='Результат клинических испытаний')),
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 1, 9, 12, 1, 51, 610646, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='substances/', verbose_name='Картинка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('percent_in', models.IntegerField(default=55, verbose_name='Процентное содержание')),
                ('cosmetic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.cosmetic')),
                ('substance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.substance')),
            ],
            options={
